...
export default function Dashboard() {
        ...
        if (typeof window !== 'undefined') {
            ...
            supabaseClient.auth.getSession().then(({ data: { session }, error }) => {
                ...
                if (session?.user?.email) {
                    ...
                    // Fallback to local storage token check or local mode
    ...
    // Functional Routing using React Router's navigate hook
    const navigateTo = (route) => {
        ...
        switch (route) {
            ...
            case 'home':
                ...
                break;
            default:
                // Handle sub-routes or modal prompts gracefully
                if (route === 'chat' || route === 'ai-football') {
                    showToast("MODULE", `${route.toUpperCase()} module active.`);
                }
                break;
        }
    };
