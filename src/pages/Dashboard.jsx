        ...
        <div className="dashboard-root">
            ...
            <section className="game-section">
                ...
                <div className="section-header-flex" style={{ marginBottom: '10px', position: 'relative', zIndex: 15 }}>
                    <div className="section-title-badge">⚽ Interactive Ball Physics Game (Tilt or Click)</div>
                    <span style={{ fontSize: '7px', color: 'var(--muted)' }}>Tilt device or click inside box to move balls</span>
                </div>
            ...
            <section className="live-now-container">
                <div className="cards-grid">
                    <div className="card card-live" onClick={() => navigateTo('group-chats')}>
