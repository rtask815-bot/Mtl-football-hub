      ...
      <div className="dashboard-wrapper">
        ...
        <header className="dashboard-header">
          ...
          <nav className="nav-links">
            <span className={`nav-link ${activeNav === 'home' ? 'active' : ''}`} onClick={() => navigateTo('home')}>SUMMARY</span>
            <span className={`nav-link ${activeNav === 'predictions' ? 'active' : ''}`} onClick={() => navigateTo('predictions')}>PREDICTIONS</span>
            <span className={`nav-link ${activeNav === 'fixtures' ? 'active' : ''}`} onClick={() => navigateTo('fixtures')}>FIXTURES</span>
            <span className={`nav-link ${activeNav === 'news' ? 'active' : ''}`} onClick={() => navigateTo('news')}>NEWS</span>
            <span className={`nav-link ${activeNav === 'community' ? 'active' : ''}`} onClick={() => navigateTo('community')}>COMMUNITY</span>
          </nav>

          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <span style={{ fontSize: '12px', fontFamily: 'monospace', color: 'var(--green)', fontWeight: 700 }}>{clock}</span>
            <button className="btn-outline" onClick={() => openSearchModal()}>🔍 Search</button>
        ...
        {/* TAB BUTTON CARDS-GRID (NAVIGATION HUB) */}
        <div className="hub-grid">
          ...
          <div className="hub-card" onClick={() => navigateTo('news')}>
            ...
            <div>
              ...
              <div className="sub">Football transfer & intel</div>
            </div>
          </div>
        </div>
        ...
        <div className="main-content-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '20px' }}>
          ...
          <div className="match-col" style={{ gridColumn: 'span 2', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div className="pro-card">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                ...
                <button className="btn-cyber" onClick={() => navigateTo('predictions')}>
                  See More Matches →
                </button>
              </div>
              ...
              <div style={{ textAlign: 'center', marginTop: '16px' }}>
                <button className="btn-outline" style={{ width: '100%', padding: '10px' }} onClick={() => navigateTo('predictions')}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            {/* 4 FIXTURES SUMMARY CONTAINER */}
            <div className="pro-card">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                <h3 style={{ fontSize: '14px', fontWeight: 800 }}>📅 FIXTURES (4)</h3>
                <button className="btn-outline" style={{ fontSize: '10px', padding: '4px 8px' }} onClick={() => navigateTo('fixtures')}>
                  See More
                </button>
              </div>
            ...
            <div className="pro-card">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                ...
                <button className="btn-outline" style={{ fontSize: '10px', padding: '4px 8px' }} onClick={() => navigateTo('news')}>
                  See More
                </button>
              </div>
