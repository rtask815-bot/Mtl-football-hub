                ...
                <div className="dashboard-panel" style={{ marginTop: '14px', position: 'relative', zIndex: 15 }}>
                    <div className="ai-brief-box-animated">
                        ...
                        <div className="ai-brief-content">
                            <div>
                                <div style={{ fontSize: '11px', fontWeight: 800, color: 'gold', marginBottom: '4px' }}>THIS IS A COMMUNITY OF FOOTBALL FANS</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="dashboard-main-grid">
                    <div className="dashboard-panel" style={{ gridColumn: 'span 2' }}>
                        ...
                        <div className="scorers-grid">
                            <div>
                                <div style={{ fontSize: '10px', fontWeight: 900, color: 'var(--muted)', marginBottom: '6px', textTransform: 'uppercase' }}>Top Scorers</div>
                            ...
                            <div>
                                <div style={{ fontSize: '10px', fontWeight: 900, color: 'var(--muted)', marginBottom: '6px', textTransform: 'uppercase' }}>Top Assists</div>
