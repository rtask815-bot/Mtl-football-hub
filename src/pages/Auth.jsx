                ...
                <div className="auth-card">
                    ...
                    {authMode === "login" ? (
                        <form onSubmit={handleLogin} id="loginBox">
                            ...
                            <div className="form-group" style={{marginTop: isListening && activeVoiceTarget === "email" ? '24px' : '0'}}>
                                ...
                                <div className="extra-options-row" style={{marginTop: isListening && activeVoiceTarget === "password" ? '24px' : '8px'}}>
                        ...
                        <form onSubmit={handleRegister} id="registerBox">
                            ...
                            <div className="form-group" style={{marginTop: isListening && activeVoiceTarget === "username" ? '24px' : '0'}}>
                                <label>EMAIL</label>
                                <div className="input-wrapper">
                                    <input 
                                        type="email" 
                            ...
                            <div className="form-group" style={{marginTop: isListening && activeVoiceTarget === "regEmail" ? '24px' : '0'}}>
                                <label>PASSWORD</label>
                                <div className="input-wrapper">
                                    <input 
                                ...
                                <div id="strengthMeter" style={{marginTop: isListening && activeVoiceTarget === "regPassword" ? '24px' : '8px'}}>
                                    {[0, 1, 2, 3].map((index) => {
            ...
            {isOtpModalOpen && (
                <div className="premium-modal-overlay">
                    <div className="premium-modal-card">
                        ...
                        <div className="form-group" style={{ marginBottom: "10px", marginTop: isListening && activeVoiceTarget === "phoneInput" ? '24px' : '0' }}>
                        ...
                        <button onClick={handleStartOtpFlow} className="btn-prime" style={{ marginBottom: "10px", marginTop: isListening && activeVoiceTarget === "nameInput" ? '24px' : '0' }}>Request Token Dispatch</button>
                        ...
                        <button onClick={handleVerifyOtpFlow} className="btn-prime" style={{ background: "linear-gradient(90deg, #16a34a, #22c55e)", boxShadow: "0 4px 15px rgba(22,163,74,0.3)", marginBottom: "10px", marginTop: isListening && activeVoiceTarget === "otpInput" ? '24px' : '0' }}>Verify Node Authorization</button>
            ...
            <div id="aiChatConsole" className={isChatOpen ? "open" : ""}>
                ...
                <div className="chat-input-area" style={{display: 'flex', flexDirection: 'column'}}>
                    ...
                    {isListening && activeVoiceTarget === "chatQuery" && (
                        <div style={{fontSize: '10px', fontFamily: 'Orbitron', color: 'var(--neon-cyan)', marginTop: '4px', textShadow: '0 0 6px rgba(0,245,212,0.4)'}}>
