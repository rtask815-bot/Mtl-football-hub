...
const TARGET_MODEL = "gpt-3.5-turbo-16k";
...
export default function Auth() {
    ...
    // Canvas Background FX 3D Spaceship Viewport Engine
    useEffect(() => {
    ...
    const openChatConsole = () => {
        if (!isChatOpen) {
            ...
            setChatMessages([
                {
                    role: "system",
                    content: `You are Mr Mourice, MTL Football Predictions Authorization dashboard technician. Connected User Identity Name: "${identity.name}", Email: "${identity.email}". Use internal dashboard knowledge context layers. Be concise, structured, and helpful. Analysis Temporal Benchmark Timestamp: "${currentTimestampString}".`
                },
        ...
        <div className="auth-page-wrapper">
            <style>{`
                ...
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .auth-card:hover {
                    ...
                    box-shadow: 0 30px 60px -10px rgba(0, 0, 0, 0.8), 0 0 60px rgba(56, 189, 248, 0.06);
                }
                .auth-card::before {
                    content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 2px;
                    background: linear-gradient(90deg, transparent, var(--neon-blue), var(--neon-purple), transparent);
                    animation: cardGlowSlide 4s linear infinite;
                }
                ...
                @keyframes headerTitlePulse {
                    0% { text-shadow: 0 0 10px rgba(56, 189, 248, 0.2); }
                    100% { text-shadow: 0 0 25px rgba(56, 189, 248, 0.6); }
                }
                #aiText {
                ...
                .password-toggle {
                    position: absolute; right: 54px; font-size: 11px; font-weight: 700;
                ...
                /* Google Voice Type Futuristic Wave Button & Container Animation */
                .google-voice-btn {
                ...
                .google-voice-btn:hover {
                    background: rgba(56, 189, 248, 0.1); border-color: var(--neon-blue);
                    box-shadow: 0 0 15px rgba(56, 189, 248, 0.3); transform: scale(1.05);
                }
                .google-voice-btn.listening {
                    background: linear-gradient(135deg, rgba(0, 245, 212, 0.2), rgba(56, 189, 248, 0.2));
                    border-color: var(--neon-cyan);
                    box-shadow: 0 0 25px rgba(0, 245, 212, 0.5), inset 0 0 10px rgba(0, 245, 212, 0.3);
                    animation: futuristicPulseMic 1.2s ease-in-out infinite alternate;
                }
                @keyframes futuristicPulseMic {
                    0% { transform: scale(1); box-shadow: 0 0 15px rgba(0, 245, 212, 0.4); }
                    100% { transform: scale(1.08); box-shadow: 0 0 30px rgba(0, 245, 212, 0.8), 0 0 10px rgba(168, 85, 247, 0.5); }
                }
                .google-voice-bars {
                ...
                @keyframes voiceBarDance {
                    ...
                    100% { height: 18px; box-shadow: 0 0 8px var(--neon-cyan); }
                }

                .voice-transcript-overlay {
                    position: absolute; bottom: -28px; left: 0; right: 0; font-size: 11px;
                    font-family: 'Orbitron', sans-serif; color: var(--neon-cyan); white-space: nowrap;
                    overflow: hidden; text-overflow: ellipsis; text-shadow: 0 0 8px rgba(0, 245, 212, 0.4);
                    animation: transcriptSlideUp 0.3s ease forwards;
                }
                @keyframes transcriptSlideUp {
                    from { opacity: 0; transform: translateY(-4px); }
                    to { opacity: 1; transform: translateY(0); }
                }

                /* Decorated Container Prompt for "Listening... speak now" */
                .decorated-listening-container {
                    position: absolute;
                    bottom: -36px;
                    left: 0;
                    right: 0;
                    background: linear-gradient(135deg, rgba(3, 7, 18, 0.95), rgba(17, 24, 39, 0.95));
                    border: 1px solid var(--neon-cyan);
                    box-shadow: 0 0 15px rgba(0, 245, 212, 0.3), inset 0 0 10px rgba(0, 245, 212, 0.15);
                    border-radius: 8px;
                    padding: 6px 12px;
                    display: flex;
                    align-items: center;
                    ...
                    z-index: 10;
                    animation: transcriptSlideUp 0.3s cubic-bezier(0.16, 1, 0.3, 1) forwards;
                }
                .decorated-listening-container::before {
                    content: '';
                    position: absolute;
                    top: -1px;
                    left: 10%;
                    ...
                    animation: cardGlowSlide 2s linear infinite;
                }
                .decorated-listening-text {
                    font-size: 11px;
                ...
                .btn-prime:hover:not(:disabled) {
                    ...
                    box-shadow: 0 10px 25px rgba(14, 165, 233, 0.5); filter: brightness(1.15);
                }
                .btn-prime:active {
                ...
                .premium-modal-card {
                    width: 100%; max-width: 420px; padding: 32px; border-radius: 24px;
                    background: linear-gradient(145deg, rgba(17, 24, 39, 0.98), rgba(3, 7, 18, 0.99));
                    border: 1px solid rgba(56, 189, 248, 0.25); box-shadow: 0 30px 60px rgba(0, 0, 0, 0.8), 0 0 50px rgba(56, 189, 248, 0.08);
                ...
                @keyframes launcherPulse {
                    0% { box-shadow: 0 10px 30px rgba(168, 85, 247, 0.35), 0 0 0 0 rgba(168, 85, 247, 0.4); }
                    100% { box-shadow: 0 15px 35px rgba(168, 85, 247, 0.5), 0 0 0 12px rgba(168, 85, 247, 0); }
                }
                ...
                #chatFeedStream { flex: 1; padding: 20px; overflow-y: auto; display: flex; flex-direction: column; gap: 14px; scroll-behavior: smooth; }
                ...
                .chat-input-area { padding: 14px; border-top: 1px solid rgba(255, 255, 255, 0.05); display: flex; gap: 10px; background: rgba(0, 0, 0, 0.25); position: relative; }
                #chatUserQuery {
                ...
                <div className="auth-card">
                    ...
                    {authMode === "login" ? (
                        <form onSubmit={handleLogin} id="loginBox">
                            <div className="form-group" style={{ marginBottom: isListening && activeVoiceTarget === "email" ? '36px' : '20px' }}>
                                ...
                                {isListening && activeVoiceTarget === "email" && (
                                    <div className="decorated-listening-container">
                                        <div className="decorated-listening-text">
                                            {interimTranscript ? `"${interimTranscript}"` : "Listening... Speak now"}
                                        </div>
                                        <div className="decorated-listening-waves">
                                            <div className="decorated-wave-bar" style={{height: '4px'}}></div>
                                            <div className="decorated-wave-bar" style={{height: '10px'}}></div>
                                            <div className="decorated-wave-bar" style={{height: '6px'}}></div>
                                            <div className="decorated-wave-bar" style={{height: '12px'}}></div>
                                        </div>
                                    </div>
                                )}
                            </div>
                            <div className="form-group" style={{ marginBottom: isListening && activeVoiceTarget === "password" ? '36px' : '20px' }}>
                                ...
                                {isListening && activeVoiceTarget === "password" && (
                                    <div className="decorated-listening-container">
                                        <div className="decorated-listening-text">
                                            {interimTranscript ? `"${interimTranscript}"` : "Listening... Speak now"}
                                        </div>
                        ...
                        <form onSubmit={handleRegister} id="registerBox">
                            <div className="form-group" style={{ marginBottom: isListening && activeVoiceTarget === "username" ? '36px' : '20px' }}>
                                ...
                                {isListening && activeVoiceTarget === "username" && (
                                    <div className="decorated-listening-container">
                                        <div className="decorated-listening-text">
                                            {interimTranscript ? `"${interimTranscript}"` : "Listening... Speak now"}
                                        </div>
                            ...
                            <div className="form-group" style={{ marginBottom: isListening && activeVoiceTarget === "regEmail" ? '36px' : '20px' }}>
                                <label>EMAIL</label>
                                <div className="input-wrapper">
                                    <input 
                                        type="email" 
                                ...
                                {isListening && activeVoiceTarget === "regEmail" && (
                                    <div className="decorated-listening-container">
                                        <div className="decorated-listening-text">
                                            {interimTranscript ? `"${interimTranscript}"` : "Listening... Speak now"}
                                        </div>
                            ...
                            <div className="form-group" style={{ marginBottom: isListening && activeVoiceTarget === "regPassword" ? '36px' : '20px' }}>
                                <label>PASSWORD</label>
                                <div className="input-wrapper">
                                    <input 
                                ...
                                {isListening && activeVoiceTarget === "regPassword" && (
                                    <div className="decorated-listening-container">
                                        <div className="decorated-listening-text">
                                            {interimTranscript ? `"${interimTranscript}"` : "Listening... Speak now"}
                                        </div>
            ...
            {isOtpModalOpen && (
                <div className="premium-modal-overlay">
                    <div className="premium-modal-card">
                        ...
                        <div className="form-group" style={{ marginBottom: isListening && activeVoiceTarget === "phoneInput" ? '36px' : '20px' }}>
                            ...
                            {isListening && activeVoiceTarget === "phoneInput" && (
                                <div className="decorated-listening-container">
                                    <div className="decorated-listening-text">
                                        {interimTranscript ? `"${interimTranscript}"` : "Listening... Speak now"}
                                    </div>
                        ...
                        <div className="form-group" style={{ marginBottom: isListening && activeVoiceTarget === "nameInput" ? '36px' : '10px' }}>
                            ...
                            {isListening && activeVoiceTarget === "nameInput" && (
                                <div className="decorated-listening-container">
                                    <div className="decorated-listening-text">
                                        {interimTranscript ? `"${interimTranscript}"` : "Listening... Speak now"}
                                    </div>
                        ...
                        <div className="form-group" style={{ marginBottom: isListening && activeVoiceTarget === "otpInput" ? '36px' : '20px' }}>
                            ...
                            {isListening && activeVoiceTarget === "otpInput" && (
                                <div className="decorated-listening-container">
                                    <div className="decorated-listening-text">
                                        {interimTranscript ? `"${interimTranscript}"` : "Listening... Speak now"}
                                    </div>
            ...
            <div id="aiChatConsole" className={isChatOpen ? "open" : ""}>
                    ...
                    {isChatProcessing && (
                        <div className="chat-bubble bubble-ai">
                            <div className="typing-indicator" style={{display: 'flex', gap: '4px', alignItems: 'center'}}>
                                <span style={{width: '6px', height: '6px', background: 'var(--neon-purple)', borderRadius: '50%', animation: 'pulse 0.6s infinite alternate'}}></span>
                                <span style={{width: '6px', height: '6px', background: 'var(--neon-purple)', borderRadius: '50%', animation: 'pulse 0.6s infinite alternate 0.2s'}}></span>
                                <span style={{width: '6px', height: '6px', background: 'var(--neon-purple)', borderRadius: '50%', animation: 'pulse 0.6s infinite alternate 0.4s'}}></span>
                            </div>
                        </div>
                    )}
                </div>
                <div className="chat-input-area" style={{display: 'flex', flexDirection: 'column'}}>
                    ...
                    {isListening && activeVoiceTarget === "chatQuery" && (
                        <div className="decorated-listening-container" style={{ bottom: '-32px' }}>
                            <div className="decorated-listening-text">
                                {interimTranscript ? `Voice Prompt: "${interimTranscript}"` : "Speak to AI container active... Auto-send enabled"}
                            </div>
                            <div className="decorated-listening-waves">
                                <div className="decorated-wave-bar" style={{height: '4px'}}></div>
                                <div className="decorated-wave-bar" style={{height: '10px'}}></div>
