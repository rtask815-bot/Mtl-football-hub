    ...
    useEffect(() => {
        const resolveActiveModel = async () => {
            try {
                ...
                // Fallback to default target on request failure
            }
        };
        resolveActiveModel();
    }, []);
        ...
        <div className="auth-page-wrapper">
            <style>{`
                ...
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                /* Floating Interactive Form Group Field Container for Mobile Virtual Keyboard Flexibility */
                .form-group { 
                    margin-bottom: 20px; 
                    position: relative;
                ...
                /* Floating Dynamic Overlay Container for "Listening... speak now" Prompt */
