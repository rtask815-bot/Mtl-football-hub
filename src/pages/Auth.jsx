        ...
        <div className="auth-page-wrapper">
            <style>{`
                ...
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                /* Floating Overlaying Container Prompt for 'listening...' (Keyboard-safe floating design) */
                .decorated-listening-container {
                    ...
                    right: 0;
                    margin-bottom: 8px;
                    background: linear-gradient(135deg, rgba(3, 7, 18, 0.98), rgba(17, 24, 39, 0.98));
                    border: 1px solid var(--neon-cyan);
                    box-shadow: 0 -5px 25px rgba(0, 245, 212, 0.4), 0 10px 30px rgba(0, 0, 0, 0.8), inset 0 0 10px rgba(0, 245, 212, 0.2);
                    border-radius: 10px;
                    padding: 8px 14px;
                    display: flex;
                    align-items: center;
                    ...
                    animation: floatingContainerUp 0.3s cubic-bezier(0.16, 1, 0.3, 1) forwards;
                }
                @keyframes floatingContainerUp {
