            ...
            <style>{`
                ...
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .nav-switch button {
                    ...
                    border-radius: 9px; cursor: pointer; transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1);
                }
                ...
                .listening-toast-container {
                    ...
                    box-shadow: 0 20px 40px rgba(0,0,0,.5), 0 0 15px rgba(0, 245, 212, 0.2) !important;
                ...
                #globalProcessLoader {
                    position: fixed; inset: 0; background: rgba(3, 7, 18, 0.96); backdrop-filter: blur(20px);
                    -webkit-backdrop-filter: blur(20px); z-index: 100000;
                ...
                .water-pipe-outer {
                    ...
                    border-radius: 20px;
                    padding: 3px;
                    box-shadow: inset 0 2px 8px rgba(0,0,0,0.8), 0 0 20px rgba(56, 189, 248, 0.2);
                    position: relative;
                    overflow: hidden;
                }
                .water-pipe-fill {
                    height: 100%;
                    border-radius: 14px;
                    background: linear-gradient(90deg, #0284c7, #00f5d4, #38bdf8);
                    position: relative;
                    overflow: hidden;
                ...
                #aiChatConsole {
                    ...
                    transition: opacity 0.3s ease, transform 0.3s ease, max-height 0.2s cubic-bezier(0.16, 1, 0.3, 1);
                }
