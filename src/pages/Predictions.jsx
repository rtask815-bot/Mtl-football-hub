...
export default function MatchHubApp() {
  ...
  return (
    <div className={`min-h-screen flex flex-col justify-between selection:bg-mtlGreen selection:text-black ${userProfile.high_contrast ? 'high-contrast-mode' : ''}`}>
      ...
      {/* INTERNAL CSS STYLES FOR MODERN FUTURISTIC THEME */}
      <style>{`
        :root {
          --mtl-surface: #0b0f19;
          --mtl-dark: #05070d;
          --mtl-card: #121826;
          --mtl-card-border: rgba(255, 255, 255, 0.08);
          --mtl-green: #10b981;
        ...
        .bg-mtlGreenHover:hover { background-color: var(--mtl-green-hover); }
        .bg-futuristicNeon { background-color: var(--neon-cyan); }
        .text-futuristicNeon { color: var(--neon-cyan); }
        .font-cyber { font-family: 'Courier New', Courier, monospace; letter-spacing: -0.02em; }

        /* Pro Card Glassmorphism Effect */
        .pro-card {
        ...
        /* Water-like progress bar animation */
        ...
        /* Avatar styling */
        .avatar-logo {
          background: linear-gradient(135deg, rgba(16, 185, 129, 0.2) 0%, rgba(0, 240, 255, 0.2) 100%);
          border: 1px solid var(--mtl-green);
          ...
          <section id="db-matches-section" className="bg-mtlSurface border border-mtlCardBorder rounded-2xl p-6 animate-slide-in shadow-2xl">
            ...
            {userProfile.role === 'admin' && (
              <div className="mt-6 pt-4 border-t border-mtlCardBorder flex justify-center">
                <button onClick={() => handleTriggerAdminModal('matches')} className="bg-mtlGreen text-black font-extrabold px-6 py-2.5 rounded-full text-xs uppercase tracking-wider hover:bg-mtlGreenHover transition flex items-center gap-2">
        ...
        {isChatDrawerOpen && (
          <div className="absolute bottom-20 right-0 w-80 sm:w-96 bg-mtlSurface border border-mtlCardBorder rounded-2xl shadow-2xl flex flex-col h-[480px] overflow-hidden">
            ...
            <div className="p-3 border-t border-mtlCardBorder bg-mtlDark flex gap-2">
              ...
              />
              <button onClick={handleSendGlobalChatMessage} className="bg-mtlGreen text-black font-bold px-4 py-2 rounded-xl text-xs hover:bg-mtlGreenHover transition">Send</button>
            </div>
          </div>
        )}
      </div>
          ...
          <div className="bg-mtlSurface border border-mtlCardBorder rounded-2xl w-full max-w-2xl h-[80vh] flex flex-col overflow-hidden shadow-2xl">
            ...
            <div className="p-3 border-t border-mtlCardBorder bg-mtlDark flex gap-2">
              <input
                ...
                className="flex-1 bg-mtlCard border border-mtlCardBorder rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-mtlGreen"
              />
              <button onClick={handleSendMatchChatMessage} className="bg-mtlGreen text-black font-bold px-4 py-2 rounded-xl text-xs hover:bg-mtlGreenHover transition">Post</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-mtlSurface border border-mtlCardBorder rounded-2xl w-full max-w-2xl p-8 space-y-6 shadow-2xl relative">
            ...
            <div className="flex justify-end gap-4 border-t border-mtlCardBorder pt-4">
              ...
              <button onClick={handleSaveAdminEntry} className="px-6 py-2.5 rounded-xl text-xs bg-mtlGreen text-black font-extrabold hover:bg-mtlGreenHover transition">Save Entry</button>
            </div>
          </div>
        </div>
      )}
