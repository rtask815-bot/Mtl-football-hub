      ...
      >
        ...
        <div className="flex items-center justify-between my-4">
          <div className="text-center flex-1">
            ...
            <span class="text-xs font-bold tracking-wide text-white">{sanitizeInput(home)}</span>
          </div>
          ...
          <div className="text-center flex-1">
            ...
            <span class="text-xs font-bold tracking-wide text-white">{sanitizeInput(away)}</span>
          </div>
        </div>
