...
export default function App() {
  ...
  return (
    <>
      ...
      <div className={`min-h-screen flex flex-col justify-between selection:bg-[#00ff75] selection:text-black ${userProfile.high_contrast ? 'high-contrast-mode' : ''} bg-[#080c14] text-white font-sans`}>
            ...
            {globalChatOpen && (
              <div className="absolute bottom-20 right-0 w-80 sm:w-96 bg-[#0e1626] border border-[#24334d] rounded-2xl shadow-2xl flex flex-col h-[480px] overflow-hidden backdrop-blur-xl">
                ...
                <div className="p-3 border-t border-[#24334d] bg-[#080c14] flex gap-2">
                  ...
                  />
                  <button onClick={sendGlobalChatMessage} className="bg-[#00ff75] text-black font-bold px-3 py-2 rounded-xl text-xs hover:bg-[#00d866] transition">Send</button>
                </div>
              </div>
            )}
          </div>
