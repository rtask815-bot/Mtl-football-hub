...
export default function App() {
  ...
  return (
    <>
      {/* Precision Industrial Cyber Theme CSS */}
      <style>{`
        :root {
          --mtlGreen: #00ff75;
          --mtlDark: #080c14;
          ...
          {adminModal.open && (
            <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
              <div className="bg-[#0e1626] border border-[#00ff75]/40 rounded-2xl w-full max-w-2xl p-6 sm:p-8 space-y-5 shadow-2xl relative">
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <input
                          ...
                          className="bg-[#080c14] border border-[#24334d] rounded-xl p-3 text-white focus:outline-none focus:border-[#00ff75]"
                        />
                        <input
                          type="time"
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <input
                          ...
                          className="bg-[#080c14] border border-[#24334d] rounded-xl p-3 text-white font-mono focus:outline-none focus:border-[#00ff75]"
                        />
                      </div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full bg-[#080c14] border border-[#24334d] rounded-xl p-3 text-white focus:outline-none focus:border-[#00ff75] resize-none"
                      />
                    </>
                  )}
                  ...
                  {adminModal.section === 'trending' && (
                    <>
                      <input
                        ...
                        className="w-full bg-[#080c14] border border-[#24334d] rounded-xl p-3 text-white font-mono focus:outline-none focus:border-[#00ff75]"
                      />
                      <input
                        type="text"
                ...
                <div className="pt-4 border-t border-[#24334d] flex justify-end gap-3">
                  <button onClick={() => setAdminModal({ open: false, section: null, item: null })} className="px-4 py-2 rounded-xl text-xs text-gray-400 hover:text-white">Cancel</button>
                  <button onClick={saveAdminEntry} className="bg-[#00ff75] text-black font-extrabold px-6 py-2.5 rounded-xl text-xs hover:bg-[#00d866] transition shadow-md">Commit Record</button>
                </div>
              </div>
            </div>
          )}
