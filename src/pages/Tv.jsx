...
export default function MtlTVRoom({ targetWebsite = CONFIG.defaultTargetUrl }) {
    ...
    // Reload stream connected strictly to authenticated Supabase state
    ...
    // Supabase Auth listener and event registration
    useEffect(() => {
        const handleOnline = () => {
        ...
        // Listen for active Supabase authentication state updates
