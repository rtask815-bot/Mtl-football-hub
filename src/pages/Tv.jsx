...
// Initialize Supabase directly with provided credentials
...
export default function MtlTVRoom({ targetWebsite = CONFIG.defaultTargetUrl }) {
    ...
    // Component State
    const [streamSrc, setStreamSrc] = useState(() => getProxyUrl(targetWebsite));
    ...
    const reloadStream = useCallback(async (automatic = false) => {
        ...
        setStreamSrc(`${baseUrl}&_t=${Date.now()}`);
        updateIframeLayout();
        ...
        <main className="stream-app" id="streamApp" ref={appRef}>
            ...
            >
                ...
                <button
                    ...
                    onClick={() => window.open(targetWebsite, "_blank")}
                >
                    ↗
                </button>
                <button
