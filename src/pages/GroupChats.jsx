...
export default function GroupChats() {
  ...
  /* ============================================================
     INITIALIZATION, REALTIME, & 1-SECOND SYNC POLLER
     ============================================================ */
  useEffect(() => {
    loadCachedState();
    verifySessionAndInitialize();

    // 1-second sync interval to poll messages, counts, and updates to local storage without page refresh
  ...
  async function syncBackgroundData() {
    try {
      ...
      // Sync unread counts and general groups state
      ...
      // Silent catch for background polling interruptions
    }
  }
