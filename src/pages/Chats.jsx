  ...
  async function sendChatRequest(peerId) {
    ...
    if (existing) {
      ...
      if (existing.status === 'rejected') {
        // If previously rejected, allow sending a new request by updating or inserting
    ...
    <>
      ...
      <div className="app-container">
        <main className="workspace">
          ...
          {/* SECTION 3: Horizontal Filter Tab Pills ('All Chats', 'My chats', 'Achieved') */}
                          ...
                          <div className="chat-row-details">
                            ...
                            <div className="chat-row-sub-line">
                              ...
                              <div className="chat-row-badges">
                                ...
                                {/* Unread new message counter shown on individual chat container on the furthest end as numbers */}
              ...
              <div className="futuristic-card" style={{ padding: '14px', margin: '12px auto', maxWidth: '420px', textAlign: 'center' }}>
                ...
                <p style={{ color: 'var(--text-muted)', fontSize: '0.75rem' }}>
                  {LocalStore.get(`chat_request_status_${currentActivePeer?.id}`) === 'rejected'
                    ? "Request regected, please try again"
                    : "waiting for request approvals"}
                </p>
              </div>
            )}
