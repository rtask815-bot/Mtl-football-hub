...
export default function DirectUserChats() {
  ...
  /* ============================================================
     CHAT REQUEST APPROVAL & MESSAGE DELIVERY RESOLUTION
     ============================================================ */
    ...
    <>
      <style>{`
        :root{
          ...
          --bg-panel:#121b29;
          --bg-card:#182538;
          --border-glow:rgba(82, 136, 193, 0.4);
          --tg-accent:#0088cc;
          --tg-accent-hover:#0077b3;
          --tg-pill-bg:rgba(255, 255, 255, 0.08);
          --tg-pill-active:#0088cc;
        ...
        *{box-sizing:border-box;margin:0;padding:0;font-family:'Segoe UI',-apple-system,BlinkMacSystemFont,Roboto,sans-serif;scrollbar-width:thin;scrollbar-color:var(--tg-accent) var(--bg-deep)}
        ...
        .loader-overlay{position:fixed;inset:0;background:rgba(9, 13, 22, 0.92);backdrop-filter:blur(12px);z-index:999;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:20px}
        ...
        .cube-face{position:absolute;width:60px;height:60px;background:rgba(0, 136, 204, 0.2);border:2px solid var(--tg-accent);box-shadow:0 0 15px rgba(0, 136, 204, 0.5)}
        ...
        .loader-text{font-size:0.85rem;font-weight:700;letter-spacing:2px;color:var(--tg-accent);text-transform:uppercase;animation:pulseText 1.5s infinite ease-in-out}
        @keyframes pulseText{0%,100%{opacity:0.4}50%{opacity:1}}

        /* 3D BUTTONS */
        .btn-3d{position:relative;background:linear-gradient(135deg, #0088cc, #005580);color:#fff;border:none;border-radius:10px;padding:10px 18px;font-weight:700;font-size:0.85rem;cursor:pointer;box-shadow:0 6px 0 #003350, 0 10px 20px rgba(0,0,0,0.4);transition:all 0.15s ease;display:inline-flex;align-items:center;justify-content:center;gap:8px;text-transform:uppercase;letter-spacing:0.5px;transform:perspective(500px) translateZ(0)}
        .btn-3d:hover{transform:perspective(500px) translateZ(4px);box-shadow:0 8px 0 #003350, 0 12px 25px rgba(0,0,0,0.5)}
        .btn-3d:active{transform:perspective(500px) translateZ(-2px) translateY(4px);box-shadow:0 2px 0 #003350, 0 4px 10px rgba(0,0,0,0.4)}
        .btn-3d-danger{background:linear-gradient(135deg, #e17076, #9e3035);box-shadow:0 6px 0 #611a1d, 0 10px 20px rgba(0,0,0,0.4)}
        .btn-3d-danger:hover{transform:perspective(500px) translateZ(4px);box-shadow:0 8px 0 #611a1d, 0 12px 25px rgba(0,0,0,0.5)}
        .btn-3d-danger:active{transform:perspective(500px) translateZ(-2px) translateY(4px);box-shadow:0 2px 0 #611a1d, 0 4px 10px rgba(0,0,0,0.4)}
        .btn-3d-success{background:linear-gradient(135deg, #2ecc71, #1b8a4b);box-shadow:0 6px 0 #10522c, 0 10px 20px rgba(0,0,0,0.4)}
        .btn-3d-success:hover{transform:perspective(500px) translateZ(4px);box-shadow:0 8px 0 #10522c, 0 12px 25px rgba(0,0,0,0.5)}
        .btn-3d-success:active{transform:perspective(500px) translateZ(-2px) translateY(4px);box-shadow:0 2px 0 #10522c, 0 4px 10px rgba(0,0,0,0.4)}

        /* FUTURISTIC 3D CONTAINERS & ANIMATIONS */
        .futuristic-card{background:linear-gradient(145deg, rgba(24, 37, 56, 0.9), rgba(18, 27, 41, 0.95));border:1px solid rgba(82, 136, 193, 0.35);border-radius:16px;box-shadow:0 12px 40px 0 rgba(0, 0, 0, 0.5), inset 0 1px 0 0 rgba(255,255,255,0.1);backdrop-filter:blur(12px);transform:perspective(1000px) rotateX(1deg);transition:all 0.3s cubic-bezier(0.16, 1, 0.3, 1)}
        .futuristic-card:hover{transform:perspective(1000px) rotateX(0deg) translateY(-2px);box-shadow:0 16px 50px 0 rgba(0, 136, 204, 0.2), inset 0 1px 0 0 rgba(255,255,255,0.2);border-color:rgba(0, 136, 204, 0.6)}
        ...
        @keyframes typingEffectAnim {
          from { width: 0; }
          to { width: 100%; }
        }

        .anim-slide-in { animation: slideInLeft 0.4s cubic-bezier(0.16, 1, 0.3, 1) forwards; }
        .anim-slide-out { animation: slideOutRight 0.3s cubic-bezier(0.16, 1, 0.3, 1) forwards; }
        
        .scrolling-ticker { overflow: hidden; white-space: nowrap; position: relative; width: 100%; }
        .scrolling-ticker span { display: inline-block; animation: textScrollAnim 12s linear infinite; }
        
        .typing-effect { overflow: hidden; white-space: nowrap; animation: typingEffectAnim 3s steps(40, end); }
        ...
        .chat-list-group{display:flex;flex-direction:column;gap:8px;padding:12px 16px}
        ...
        /* PREMIUM FUTURISTIC CHAT ROW ITEM */
        .chat-row-item{display:flex;align-items:center;justify-content:space-between;padding:12px 18px;background:linear-gradient(135deg, rgba(24, 37, 56, 0.7), rgba(18, 27, 41, 0.85));border:1px solid rgba(82, 136, 193, 0.2);border-radius:14px;cursor:pointer;transition:all 0.25s ease;user-select:none;position:relative;box-shadow:0 6px 20px rgba(0,0,0,0.3);transform:perspective(800px) translateZ(0)}
        .chat-row-item:hover{background:linear-gradient(135deg, rgba(0, 136, 204, 0.15), rgba(24, 37, 56, 0.9));border-color:var(--tg-accent);transform:perspective(800px) translateZ(6px);box-shadow:0 10px 30px rgba(0, 136, 204, 0.25)}
        .chat-row-left{display:flex;align-items:center;gap:14px;min-width:0;flex:1}
        .chat-row-avatar-box{position:relative;width:50px;height:50px;min-width:50px;border-radius:50%;background:linear-gradient(135deg, var(--tg-accent), #6c5ce7);display:flex;align-items:center;justify-content:center;font-size:1.1rem;font-weight:700;color:#fff;overflow:hidden;flex-shrink:0;box-shadow:0 0 15px rgba(0,136,204,0.4)}
        .chat-row-avatar-box img{width:100%;height:100%;object-fit:cover;border-radius:50%}
        .online-dot{position:absolute;width:12px;height:12px;right:2px;bottom:2px;border-radius:50%;background:var(--tg-online);border:2px solid var(--bg-deep);box-shadow:0 0 8px var(--tg-online)}
        
        .chat-row-details{display:flex;flex-direction:column;gap:4px;min-width:0;flex:1}
        .chat-row-header-line{display:flex;align-items:center;justify-content:space-between;gap:8px}
        .chat-row-name{font-size:0.95rem;color:#fff;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
        .chat-row-time{font-size:0.75rem;color:var(--text-muted);white-space:nowrap}
        ...
        .unread-pill{background:var(--tg-accent);color:#fff;font-size:0.68rem;font-weight:700;padding:2px 7px;border-radius:12px;min-width:18px;text-align:center;box-shadow:0 0 10px var(--tg-accent)}
        ...
        .chat-messages-area{position:relative;flex:1;min-height:0;padding:16px clamp(12px, 3vw, 28px) 130px;overflow-y:auto;display:flex;flex-direction:column;gap:6px;background:var(--bg-deep);scroll-behavior:smooth}
        ...
        /* CONTAINER PROMPT OVERLAY PLACED ABOVE CHAT CONTAINER */
        .send-request-container-prompt{background:linear-gradient(145deg, rgba(18, 27, 41, 0.98), rgba(24, 37, 56, 0.99));border:1px solid rgba(0, 136, 204, 0.5);border-radius:16px;padding:18px;margin:14px auto;width:min(94%, 580px);box-shadow:0 12px 35px rgba(0,0,0,0.6), 0 0 20px rgba(0,136,204,0.2);display:flex;flex-direction:column;gap:12px;text-align:center;position:relative;z-index:10;transform:perspective(800px) translateZ(10px);animation:slideInLeft 0.3s ease-out}
        .send-request-container-prompt h4{color:var(--tg-accent);font-size:1rem;font-weight:700;display:flex;align-items:center;justify-content:center;gap:6px}
        .send-request-container-prompt p{color:var(--text-muted);font-size:0.82rem;line-height:1.4}
        .send-request-container-actions{display:flex;align-items:center;justify-content:center;gap:10px;margin-top:4px}
            ...
            <div className={`view-section ${activeMainView === 'chats' ? 'active' : ''}`}>
              ...
              {pendingChatRequests.length > 0 && (
                <div style={{ padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <h4 style={{ fontSize: '0.78rem', color: 'var(--tg-accent)', textTransform: 'uppercase', letterSpacing: '1px' }} className="typing-effect">
                    Pending Chat Requests ({pendingChatRequests.length})
                  </h4>
                  {pendingChatRequests.map(req => (
                    <div key={req.id} className="futuristic-card anim-slide-in" style={{ padding: '12px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <div className="flex-row">
              ...
              <div className="chat-list-group">
                ...
                {filteredDisplayList.length === 0 ? (
                  ...
                  filteredDisplayList.map(item => {
                    ...
                    return (
                      <div
                        className="chat-row-item anim-slide-in"
                        key={item.id}
            ...
            <div className={`view-section ${activeMainView === 'predictions' ? 'active' : ''}`} style={{ padding: '16px' }}>
              ...
              <div>
                {notifications.length === 0 ? (
                  ...
                  notifications.map(n => (
                    <div
                      className="notification-item-card anim-slide-in"
                      key={n.id}
      ...
      <div className={`overlay-screen ${modals.chatRoomModal ? 'active' : ''}`} id="chatRoomModal">
        <div className="chat-room-container" ref={chatContainerRef}>
          ...
          <div className="chat-messages-area" ref={chatMessagesAreaRef}>
            {/* CONTAINER PROMPT OVERLAY PLACED ABOVE CHAT CONTAINER */}
            {!isChatUnlocked && (
              <div className="send-request-container-prompt futuristic-card">
                ...
                <p>
                  {LocalStore.get(`chat_request_status_${currentActivePeer?.id}`) === 'rejected'
                    ...
                    : "This user requires a chat request approval before direct messages can be exchanged."}
                </p>
                    ...
                    return messages.map(m => {
                      ...
                      return (
                        <React.Fragment key={m.id}>
                          ...
                          <div className={`message-bubble ${isOwnMessage ? 'outgoing' : 'incoming'} anim-slide-in`}>
          ...
          <div className="chat-input-floating-wrapper">
            <div className="chat-input-bar">
              <textarea
                placeholder={isChatUnlocked ? "Message" : "Send chat request message..."}
                rows={1}
                value={chatInputText}
                onChange={(e) => {
              ...
              <div className="chat-tools-group">
                ...
                <button className="send-btn btn-3d" style={{ padding: '0', width: '36px', height: '36px' }} onClick={sendChatMessage} title="Send Message">
      ...
      <div className={`overlay-screen ${modals.userAboutModal ? 'active' : ''}`}>
        <div className="modal-box futuristic-card" style={{ textAlign: 'center' }}>
      ...
      <div className={`overlay-screen ${modals.newDirectChatModal ? 'active' : ''}`}>
        <div className="modal-box futuristic-card">
          <div className="modal-header">
      ...
      {customPrompt && (
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: 'rgba(0,0,0,0.8)', zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
          <div style={{ width: '100%', maxWidth: '400px' }}>
            <div className="decorated-prompt-box futuristic-card">
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', marginTop: '12px' }}>
                ...
                <button
                  className="btn-3d"
                  style={{ background: customPrompt.confirmBg || 'var(--tg-accent)', color: customPrompt.confirmColor || '#fff' }}
                  onClick={() => {
                    let val;
