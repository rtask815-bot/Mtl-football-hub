    ...
    <div className="telegram-app-root">
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; }
        ...
        .tg-messages-box { flex: 1; overflow-y: auto; padding: 16px; display: flex; flex-direction: column; gap: 8px; background: #0e1621; }
      ...
      <div className="tg-container">
        ...
        <div className="tg-tabs-bar">
          ...
          <button className={`tg-tab-pill ${telegramTab === 'REQUESTS' ? 'active' : ''}`} onClick={() => setTelegramTab('REQUESTS')}>
            SEND CHAT REQUEST ({availableUsers.length})
          </button>
