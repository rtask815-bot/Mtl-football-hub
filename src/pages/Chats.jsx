    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;font-family:'Segoe UI',-apple-system,BlinkMacSystemFont,Roboto,sans-serif;scrollbar-width:thin;scrollbar-color:var(--tg-accent) var(--bg-deep)}
        ...
        /* SEND REQUEST CONTAINER PROMPT */
        .send-request-container-prompt{background:linear-gradient(145deg, rgba(18, 27, 41, 0.95), rgba(24, 37, 56, 0.98));border:1px solid rgba(0, 136, 204, 0.35);border-radius:14px;padding:16px;margin:12px auto;width:min(100%, 540px);box-shadow:0 8px 24px rgba(0,0,0,0.5);display:flex;flex-direction:column;gap:12px;text-align:center;position:relative;z-index:2}
        .send-request-container-prompt h4{color:var(--tg-accent);font-size:0.95rem;font-weight:700;display:flex;align-items:center;justify-content:center;gap:6px}
        .send-request-container-prompt p{color:var(--text-muted);font-size:0.8rem;line-height:1.4}
